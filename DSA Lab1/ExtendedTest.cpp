...
void testIteratorSteps(Bag& bag) {
	...
	//cout << "Test iteratorSteps - SUCCESS" << endl;
}
...
void testIterator() { 
	...
	cout << "Test iterator - SUCCESS" << endl;
}
...
void testQuantity() {
	...
	assert(b.size() == 0);
	cout << "Test quantity - SUCCESS" << endl;
}
